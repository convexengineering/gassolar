...
\begin{figure}[H]
 \begin{subfigmatrix}{2}% number of columns
     \subfigure[No structural model\label{f:nostruct}]{\includegraphics{bvslatsolar.pdf}}
     \subfigure[With structural model\label{f:wstruct}]{\includegraphics{bvslatsolar.pdf}}
 \end{subfigmatrix}
