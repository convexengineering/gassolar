...
\begin{equation}
    \label{e:fusesa}
    \left( \frac{3}{/pi} S_{fuse} \right)^{1.6075} \geq (4lR)^{1.6075} + (4R^2)^{1.6075}.
\end{equation}
...
\begin{align}
    \label{e:fusedrag}
    D &\geq C_f k_{fuse} \frac{1}{2} \rho V^2 S_{fuse} \\
...
The engine weight of the gas powered aircraft is governed by a simple power law.
