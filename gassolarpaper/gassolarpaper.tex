...
Long-endurance, gas-powered aircraft are primarily sized by the amount of fuel required to achieve a given endurance. 
The amount of fuel is determined largely by the endurance requirement, efficiency of the propulsive system, the wind speed, and aircraft drag. 
The wind speed is a function latitude and required percentile wind speed.
The efficiency of the propulsive system is determined by the engine and propeller selection.  
The drag is a function of the shape of the aircraft's speed and shape.
Solar-electric powered aircraft are primarily sized by the number solar cells and batteries required to fly during the day while storing enough energy to fly through the night. 
The length of the day and the solar energy available during the day are functions of latitude and season. 
The number of solar cells and batteries is determined by solar cell efficiency, battery energy density, velocity, and aircraft drag.
Because of these dependencies, varying even one parameter can drastically change the design and aircraft performance.

To capture the interaction of all of these parameters and requirements, a geometric programming optimization model is built for both the gas and solar-electric powered, long-endurance aircraft.  
...
Using this methodology, trade offs can be observed between different aircraft configurations, power sources, and requirements.  
The results show that gas-powered aircraft can generally be built lighter and can fly faster and can therefore fly at higher latitudes and in percentile wind speeds.  
